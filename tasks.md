...
### ✅ 1.4 ระบบลืมรหัสผ่าน (Frontend + Backend)
...
### ✅ 1.6 หน้าโปรไฟล์ (Frontend + Backend)
...
## 🟡 7. ผู้ใช้/สิทธิ์ (User Management) - สำคัญปานกลาง
...
## 🟡 8. ข่าวสาร/แจ้งเตือน (News & Notifications) - สำคัญปานกลาง
...
### ⏳ 8.3 เชื่อมต่อ LINE/Email
- ตั้งค่า LINE Notify/SMTP
- Webhook สำหรับแจ้งเตือน (หากทำได้)

---

## 🟡 9. การตั้งค่า (System Settings) - สำคัญปานกลาง
...
## 🟡 10. คุณภาพ/ความปลอดภัย (Quality & Security) - สำคัญปานกลาง

### ⏳ 10.1 ตรวจสอบข้อมูล (Validation)
- ตรวจสอบข้อมูลฝั่ง Frontend/Backend
- ข้อความผิดพลาดที่ชัดเจน/รองรับภาษาไทย

### ⏳ 10.2 ชุดทดสอบ (Testing)
- Unit/Integration Tests
- ทดสอบบริการสำคัญ (Auth/Booking/Billing)

### ⏳ 10.3 มาตรการความปลอดภัย
- Hash รหัสผ่าน
- ป้องกัน SQL Injection/XSS/CSRF

### ⏳ 10.4 ปรับประสิทธิภาพ
- Lazy loading
- Database indexing

---

## 🟢 11. รายงาน (Reports) - สำคัญน้อย

### ⏳ 11.1 รายงานอัตราเข้าพัก
...
## 🟢 12. ระบบ (System) - สำคัญน้อย

### ⏳ 12.1 สำรอง/กู้คืนข้อมูล
- สคริปต์สำรองฐานข้อมูลอัตโนมัติ
- คู่มือการกู้คืนข้อมูล

### ⏳ 12.2 นำเข้า/ส่งออก CSV
- นำเข้า/ส่งออกข้อมูลห้อง/ผู้ใช้/บิล
- รองรับไฟล์ CSV/XLSX

### ⏳ 12.3 ตารางข้อมูลใหญ่
...
## 🟢 13. แจ้งซ่อม/ร้องขอ (Maintenance Requests) - สำคัญน้อย
...
## 🟢 14. ข้อตกลง (Contract/Rules) - สำคัญน้อย
...
### แยกตามความสำคัญ
- 🔴 **สำคัญที่สุด**: 15 งาน (การยืนยันตัวตน + ห้องพัก + การจอง)
- 🟠 **สำคัญมาก**: 16 งาน (แดชบอร์ด + บิล/ชำระเงิน + ค่าน้ำไฟ)
- 🟡 **สำคัญปานกลาง**: 12 งาน (ผู้ใช้ + ข่าวสาร + ตั้งค่า + ความปลอดภัย)
- 🟢 **สำคัญน้อย**: 6 งาน (รายงาน + ระบบ + แจ้งซ่อม + ข้อตกลง)

**กำหนดเสร็จ**: 2025-09-01

**แนะนำลำดับการทำ:**
1. เริ่มจาก 🔴 สำคัญที่สุด (การยืนยันตัวตน → ห้องพัก → การจอง)
2. ต่อด้วย 🟠 สำคัญมาก (แดชบอร์ด → บิล/ชำระเงิน → ค่าน้ำไฟ)
